...
const Collection = () => {
  ...
  // Debugging logs for initial products
  useEffect(() => {
    console.log('Products from context:', products);
  }, [products]);

  // Get unique categories and subcategories dynamically
  ...
  const applyFilter = () => {
    ...
    console.log('Original Products:', productsCopy);
    ...
    console.log('Filtered Products after applyFilter:', productsCopy);
  ...
  useEffect(() => {
    ...
    return () => applyFilterDebounced.cancel();
